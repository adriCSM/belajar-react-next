...
export default function FormLanjutan({ ...props }) {
  ...
  return (
    <div className="  sm:m-5 ">
      ...
      <div className="flex flex-col sm:flex-row text-sm w-full justify-center items-start divide-x">
        <div className="grid grid-cols-2 gap-x-4 pb-5 p-5 text-gray-600 md:w-2/3  sm:max-h-[500px] overflow-auto ">
        ...
        <div className="flex flex-col p-5 text-gray-600 max-h-[500px] w-full sm:w-1/3 overflow-auto text-start">
          ...
          <table className="table-auto  text-left overflow-x-auto">
            <thead>
              <tr>
                <th className="w-1/3 sm:w-1/2">Nomorc RM</th>
                <td>: -</td>
              </tr>
            </thead>
            <tbody>
