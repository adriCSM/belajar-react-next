...
export default function Card(props: any) {
  ...
  return (
    <Link href={href}>
      <div
        key={i}
        className={`${styleCard} flex flex-col items-center h-32 justify-around md:h-40 lg:h-60  items-center flex flex-col  ring-4 shadow-md rounded-md md:rounded-2xl transition transform duration-300 hover:scale-105`}
      >
